...
#define BUTTON_LONG_LONG_CLICK_TIME 6000 //ms nhấn giữ trên 3s là kích hoạt longlongclick
#define BUTTON_LONG_CLICK_TIME 3000 //ms nhấn giữ trên 3s là kích hoạt longclick
